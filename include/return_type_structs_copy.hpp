#ifndef RETURN_TYPE_STRUCTS_copy_H
#define RETURN_TYPE_STRUCTS_copy_H
...
struct Dynamics_Jacobians_Struct {
    ...
    // std::vector<Eigen::Matrix<T, 2, 2> > xdotx;
    // std::vector<Eigen::Matrix<T, 2, 3> > xdotu;
...
#include "../source/return_type_structs_copy.cpp"
